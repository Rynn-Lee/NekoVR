...
websocket-connection_lost-desc = Il semble que le serveur NekoVR ait planté. Vérifiez les logs et redémarrez le programme.
websocket-timedout = Impossible de se connecter au serveur
websocket-timedout-desc = Il semble que le serveur NekoVR ait planté ou que le délai d'attente ait expiré. Vérifiez les logs et redémarrez le programme.
websocket-error-close = Quitter NekoVR
websocket-error-logs = Ouvrir le dossier des logs

## Update notification

version_update-title = Nouvelle version disponible: { $version }
version_update-description = Cliquer sur « { version_update-update } » téléchargera l'installateur NekoVR pour vous.
...
tips-turn_on_tracker = Vous utilisez des capteurs officiels NekoVR ? N'oubliez pas <b><em>d'allumer votre capteur</em></b> après l'avoir connecté au PC !
...
board_type-SLIMEVR_DEV = Carte de développement NekoVR
...
widget-developer_mode-filter_slimes_and_hmd = Filtrer les capteurs NekoVR et le casque VR
...
tracker-settings-forget-description = Supprime le capteur du serveur NekoVR et l'empêche de s'y connecter jusqu'à ce que le serveur soit redémarré. La configuration du capteur ne sera pas perdue.
...
settings-general-interface-use_tray-description = Vous permet de fermer la fenêtre sans fermer le serveur NekoVR afin que vous puissiez continuer à l'utiliser sans l'interface graphique.
...
settings-general-interface-discord_presence-description = Indique à votre client Discord que vous utilisez NekoVR avec le nombre de capteurs IMU que vous utilisez.
...
settings-interface-behavior-error_tracking-description_v2 =
    ...
    <b>Nous ne collectons pas d'informations personnelles</b> telles que votre adresse IP ou vos identifiants Wi-Fi. NekoVR accorde une grande importance à votre vie privée !
    
    Pour offrir la meilleure expérience utilisateur possible, nous collectons des rapports d'erreurs anonymisés, des mesures de performance et des informations sur le système d'exploitation. Cela nous aide à détecter les bugs et les problèmes liés à NekoVR. Ces données sont collectées via Sentry.io.
...
settings-osc-router-network-description =
    ...
    Ces ports peuvent être les mêmes que les autres utilisés dans le serveur NekoVR.
...
settings-osc-vmc-description =
    Modifier les paramètres spécifique au protocole VMC (Virtual Motion Capture)
           pour envoyer les données de capture de NekoVR et recevoir les données de capture d'autres applications.
...
settings-utils-advanced-open_data-description-v1 = Ouvre le dossier de configuration de NekoVR, contenant les fichiers de configuration, dans l'explorateur de fichier
settings-utils-advanced-open_data-label = Ouvrir le dossier
settings-utils-advanced-open_logs = Dossier des logs
settings-utils-advanced-open_logs-description = Ouvre le dossier des logs de NekoVR, contenant ses logs, dans l'explorateur de fichier
...
onboarding-setup_warning =
    ...
    elle est nécessaire si vous utilisez NekoVR pour la première fois.
...
onboarding-wifi_creds-description-v2 =
    La plupart des capteurs (comme les capteurs officiels NekoVR) utilisent le Wi-Fi pour se connecter au serveur.
...
onboarding-home = Bienvenue sur NekoVR
...
onboarding-connect_serial-error-modal-no_serial_device_found-desc =
    ...
    Si cela ne fonctionne pas :
      ...
      - Essayez de réinstaller le serveur NekoVR et cochez « USB Drivers » dans la section des composants
...
onboarding-automatic_mounting-description = Pour que vos capteurs NekoVR fonctionnent, nous devons attribuer une rotation à vos capteurs pour les aligner avec la rotation réelle de ces derniers.
...
onboarding-automatic_proportions-description = Pour que les capteurs NekoVR fonctionnent, nous devons connaître la longueur de vos os.
...
onboarding-automatic_proportions-requirements-descriptionv2 =
    ...
    Vos capteurs et votre casque VR sont connectés au serveur NekoVR et fonctionnent correctement (ex. pas de lag, déconnexions, etc).
    Votre casque envoie sa position au serveur NekoVR (cela signifie généralement que SteamVR est ouvert et connecté à NekoVR en utilisant le pilote SteamVR de NekoVR).
...
onboarding-user_height-description = Nous avons besoin de votre taille pour calculer les proportions de votre corps ainsi que pour représenter précisément vos mouvements. Vous pouvez laisser NekoVR la calculer ou entrer votre taille manuellement.
...
trackers_still_on-modal-description =
    ...
    Voulez-vous quand même quitter NekoVR ?
trackers_still_on-modal-confirm = Quitter NekoVR
...
status_system-StatusSteamVRDisconnected =
    { $type ->
        [steamvr_feeder] Impossible de se connecter au NekoVR Feeder App.
       *[other] Impossible de se connecter à SteamVR via le pilote NekoVR.
    }
...
status_system-StatusPublicNetwork = Votre profil réseau est actuellement défini comme étant public. Ce n’est pas recommandé pour le fonctionnement correct de NekoVR. <PublicFixLink>Voyez comment y remédier ici.</PublicFixLink>
...
firmware_tool-flashbtn_step-board_SLIMEVR = Éteignez le capteur, retirez le boîtier (s'il y en a un), connectez un câble USB à votre ordinateur, puis effectuez l'une des étapes suivantes en fonction de la révision de votre carte NekoVR :
...
firmware_update-devices-description = Veuillez sélectionner les capteurs que vous souhaitez mettre à jour à la dernière version du micrologiciel NekoVR
...
unknown_device-modal-description =
    ...
    Voulez-vous le connecter à NekoVR ?
...
vrc_config-page-desc = Cette page montre l’état de vos paramètres VRChat et montre quels paramètres sont incompatibles avec NekoVR. Il est fortement recommandé de corriger tous les avertissements qui s’affichent ici pour la meilleure expérience utilisateur avec NekoVR.
...
tracking_checklist-status-incomplete = Vous n’êtes pas prêt à utiliser NekoVR !
tracking_checklist-status-partial =
    { $count ->
        [one] Vous avez 1 avertissement !
       *[other] Vous avez { $count } avertissements !
    }
tracking_checklist-status-complete = Vous êtes prêt à utiliser NekoVR !
...
tracking_checklist-NETWORK_PROFILE_PUBLIC-desc =
    { $count ->
        [one] Votre profil de réseau est actuellement défini comme étant public. Ce n’est pas recommandé pour le fonctionnement correct de NekoVR. <PublicFixLink>Voyez comment y remédier ici.</PublicFixLink>
       *[other]
            Certains de vos adaptateurs réseau sont réglés sur public :
            { $adapters }
            Ce n’est pas recommandé pour que NekoVR fonctionne correctement.
