...
websocket-connection_lost-desc = Похоже, что произошел сбой сервера NekoVR. Проверьте логи и перезапустите программу
websocket-timedout = Не удалось подключиться к серверу
websocket-timedout-desc = Похоже, что произошел сбой сервера NekoVR или превышено время ожидания. Проверьте логи и перезапустите программу
websocket-error-close = Выйти из NekoVR
websocket-error-logs = Открыть папку логов

## Update notification

version_update-title = Доступна новая версия: { $version }
version_update-description = Нажав «{ version_update-update }», вы загрузите установщик NekoVR.
...
tips-turn_on_tracker = Используете официальные трекеры NekoVR? Не забудьте <b><em>включить трекер</em></b> после его подключения к ПК!
tips-failed_webgl = Не удалось инициализировать WebGL.

## Navbar
navbar-home = Главная
navbar-trackers_assign = Назначение
navbar-mounting = Калибровка
navbar-body_proportions = Пропорции
...
reset-reset_all_warning_default-v2 =
    <b>Внимание:</b> Вы не настроили свой рост в NekoVR, ваши пропорции будут сброшены до дефолтных вместе с ростом.
    Вы уверены, что хотите это сделать?
...
widget-developer_mode-filter_slimes_and_hmd = Фильтровать трекеры NekoVR и HMD
...
tracker-settings-forget-description = Убирает трекер с NekoVR Сервер и запрещает ему подключаться к серверу до того как он будет перезапущен. Конфигурация трекера не будет потеряна.
...
settings-interface-theme-dark-orange = Тёмно-оранжевая
settings-interface-theme-dark-purple = Фиолетовая
settings-interface-theme-dark-gray = Тёмно-серая
settings-interface-theme-light-clean = Белая
settings-interface-theme-dark-orange-desc = Графитовый фон с оранжевыми акцентами
settings-interface-theme-dark-purple-desc = Тёмный обсидиан с неоновым фиолетовым
settings-interface-theme-dark-gray-desc = Монохромная тёмно-серая тема
settings-interface-theme-light-clean-desc = Чистая светлая тема
...
settings-general-interface-connected_trackers_warning-description = Эта опция будет показывать предупреждение каждый раз, когда вы пытаетесь выйти из NekoVR с одним или несколькими подключенными трекерами. Он напомнит вам о необходимости выключить трекеры, когда вы закончите, чтобы продлить срок службы батареи.
...
settings-general-interface-use_tray-description = Позволяет закрыть окно, не закрывая сервер NekoVR, так что вы можете продолжать использовать его, не беспокоясь о графическом интерфейсе.
...
settings-general-interface-discord_presence-description = Сообщает вашему приложению Discord, что вы используете NekoVR, вместе с количеством IMU трекеров, которые вы используете.
...
settings-interface-behavior-error_tracking-description_v2 =
    ...
    <b>Мы не собираем личную информацию</b>, такую как ваш IP адрес или учётные данные беспроводной сети. NekoVR ценит вашу конфиденциальность!
    Чтобы обеспечить наилучший опыт для пользователей, мы собираем анонимные отчёты об ошибках, показатели производительности и информацию об операционной системе. Это помогает нам обнаруживать ошибки и проблемы со NekoVR. Эти данные собираются с помощью Sentry.io.
...
settings-osc-router-network-description =
    ...
    Они могут быть такими же, как и другие порты, используемые на сервере NekoVR.
...
settings-osc-vmc-description =
    ...
    , чтобы отправлять данные о костях NekoVR и получать данные о костях из других приложений.
...
settings-utils-advanced-open_data-description-v1 = Открыть в проводнике папку конфигурации NekoVR, содержащую файлы конфигурации
settings-utils-advanced-open_data-label = Открыть папку
settings-utils-advanced-open_logs = Папка логов
settings-utils-advanced-open_logs-description = Открыть в проводнике папку логов NekoVR, содержащую логи приложения
...
onboarding-setup_warning =
    ...
    она необходима, если вы впервые используете NekoVR.
...
onboarding-feature-quick = Быстрый старт
onboarding-feature-precise = Точный трекинг
onboarding-feature-freedom = Свобода движений
...
onboarding-connect_serial-error-modal-no_serial_device_found-desc =
    ...
    Если это не помогло:
      ...
      - Попробуйте переустановить сервер NekoVR и выберите «USB-драйверы» в разделе компонентов
...
onboarding-automatic_mounting-description = Чтобы трекеры NekoVR работали, нам необходимо назначить поворот крепления для ваших трекеров, чтобы выровнять их с вашим физическим креплением трекера.
...
onboarding-automatic_proportions-description = Чтобы трекеры NekoVR работали, нам нужно знать длину ваших костей. Эта короткая калибровка измерит его для вас.
...
onboarding-automatic_proportions-requirements-descriptionv2 =
    ...
    Ваши трекеры и гарнитура подключены к серверу NekoVR, и правильно функционируют (например, отсутствие лагов, отключений и т. д.)
    Ваша гарнитура передает данные о местоположении на сервер NekoVR (обычно это означает, что SteamVR запущен и подключен к NekoVR с помощью драйвера SteamVR).
...
trackers_still_on-modal-description =
    ...
    Вы точно хотите выйти из NekoVR?
trackers_still_on-modal-confirm = Выйти из NekoVR
...
status_system-StatusSteamVRDisconnected =
    { $type ->
        [steamvr_feeder] В настоящее время не подключен к приложению NekoVR Feeder.
       *[other] В настоящее время не подключен к SteamVR через драйвер NekoVR.
    }
...
status_system-StatusPublicNetwork = В настоящее время ваш сетевой профиль отмечен как "Общедоступный". Для корректной работы NekoVR  не рекомендуется использовать эту настройку. <PublicFixLink>Узнать, как это исправить, здесь.</PublicFixLink>
...
firmware_tool-flashbtn_step-board_SLIMEVR = Отключите трекер, извлеките его из корпуса (если он есть), подключите USB кабель к компьютеру, затем выполните одно из следующих действий в соответствии с ревизией вашей платы от NekoVR:
...
firmware_update-devices-description = Пожалуйста, выберите трекеры, которые вы хотите обновить до последней версии прошивки NekoVR
...
unknown_device-modal-description =
    ...
    Хотите подключить его к NekoVR?
...
vrc_config-page-desc = На этой странице показаны выбранные настройки VRChat и указано, какие настройки несовместимы со NekoVR. Настоятельно рекомендуется исправить все предупреждения, отображаемые здесь, для получения наилучшего опыта с использованием NekoVR.
...
dataset_recorder-profile-custom = Диагностическая запись / Минимальный (активен)
...
dataset_recorder-severity-info = Готово
dataset_recorder-finding-DATASET_READY = Эта сборка прошла проверку готовности датасета.
dataset_recorder-finding-DATASET_READY_GATE_PENDING = Production-запись заблокирована до успешного отчёта готовности датасета.
dataset_recorder-profile-production-ready = Проверки готовности датасета пройдены; production-запись доступна
dataset_recorder-profile-production-locked = Production-профиль заблокирован до прохождения проверок готовности датасета
...
# Панель управления моделью коррекции дрифта
ai_drift-title = ИИ-коррекция дрифта
ai_drift-description = Управляемая сервером нейросетевая коррекция дрифта IMU-трекеров в реальном времени
ai_drift-tabs-label = Разделы ИИ-коррекции дрифта
ai_drift-tab-correction = Коррекция
ai_drift-tab-datasets = Датасеты
ai_drift-tab-personal = Персональное обучение
ai_drift-personal-title = Персональное обучение
ai_drift-personal-pending = Отдельная рабочая область подготовлена. Установка trainer, профили, проверка сессий и задания появятся вместе с control plane персонального обучения.
ai_drift-fail_open_notice = Обычный трекинг продолжает работать, если ИИ-коррекция или её runtime недоступны.
ai_drift-updater-title = Автообновление (GitHub)
ai_drift-updater-description = Синхронизация и проверка обновлений из ветки main
ai_model-title = Управление моделью
ai_model-description = Импорт, проверка, активация, настройка и мониторинг серверной ONNX-модели
ai_model-runtime-health = Состояние runtime
ai_model-runtime-load_state = Состояние модели
ai_model-runtime-provider = Активный provider, проверенный пробным запуском
ai_model-runtime-latency = Задержка инференса
ai_model-runtime-package = Серверный пакет runtime
ai_model-runtime-rate = Частота инференса
ai_model-runtime-queue = Очередь / пропуски
ai_model-runtime-active_model = Активная модель, подтверждённая сервером
ai_model-runtime-no_active_model = Нет активной модели
ai_model-runtime-no_active_provider = Ни один provider не подтверждён пробным запуском
ai_model-unit-ms = мс
ai_model-health-disconnected = Нет соединения с сервером
ai_model-health-disabled = Отключено
ai_model-health-unavailable = Runtime недоступен
ai_model-health-healthy = Работает
ai_model-health-degraded = Ограничено
ai_model-health-watchdog = Остановлено watchdog
ai_model-load-unavailable = Runtime недоступен
ai_model-load-unloaded = Модель выгружена
ai_model-load-loading = Загрузка
ai_model-load-active = Активна
ai_model-load-error = Ошибка загрузки
ai_model-action-enable = Включить коррекцию
ai_model-action-enable-locked = Включение заблокировано: требуется готовность
ai_model-action-disable-intent = Отключить сохранённое намерение коррекции
ai_model-action-load-diagnostic = Загрузить для диагностики
ai_model-history-switch-diagnostic = Загрузить диагностическую модель
ai_model-readiness-ready = Production-инференс готов.
ai_model-readiness-locked = Production-коррекция заблокирована.
ai_model-readiness-evidence-model = SHA-256 модели в evidence
ai_model-readiness-persisted-intent = Сохранённое намерение коррекции
ai_model-readiness-effective-state = Фактическая runtime-коррекция
ai_model-state-on = включена
ai_model-state-off = выключена
ai_model-action-disable = Отключить коррекцию
ai_model-action-unload = Выгрузить модель
ai_model-action-refresh_catalog = Обновить каталог
ai_model-action-download = Скачать и проверить
ai_model-action-activate = Активировать выбранную модель
ai_model-action-browse = Выбрать…
ai_model-action-import = Импортировать и проверить
ai_model-action-apply_settings = Применить настройки
ai_model-action-rollback = Вернуть предыдущую модель
ai_model-history-title = Недавние и закреплённые модели
ai_model-history-refresh = Обновить
ai_model-history-empty = История моделей на сервере пока пуста. Активируйте проверенную модель, чтобы добавить её сюда.
ai_model-history-personal = Персональная
ai_model-history-active = Активна
ai_model-history-compatible = Совместима
ai_model-history-pin = Закрепить модель
ai_model-history-unpin = Открепить модель
ai_model-history-switch = Переключить
ai_model-catalog-title = Проверенный каталог моделей
ai_model-catalog-label = Модель
ai_model-catalog-empty = На сервере нет доступных моделей
ai_model-catalog-downloaded = загружена
ai_model-catalog-remote = доступна для загрузки
ai_model-catalog-incompatible = Модель несовместима с конфигурацией сервера
ai_model-import-title = Импорт локальной модели
ai_model-import-model = Файл модели ONNX
ai_model-import-metadata = Сопутствующие метаданные (JSON)
ai_model-import-electron_only = Локальный импорт доступен в настольном приложении: серверу нужны выбранные пользователем пути к файлам.
ai_model-settings-title = Настройки инференса и безопасности
ai_model-settings-provider = Запрошенный provider
ai_model-settings-provider_notice = Это запрос, а не определение оборудования. Provider становится активным только после успешного пробного запуска модели на сервере.
ai_model-settings-context = Кадров контекста
ai_model-settings-confidence = Порог confidence (0–1)
ai_model-settings-max_correction = Максимальная коррекция (рад)
ai_model-settings-max_rate = Максимальная угловая скорость (рад/с)
ai_model-settings-max_acceleration = Максимальное угловое ускорение (рад/с²)
ai_model-settings-smoothing = Сглаживание (0–1)
ai_model-settings-stale_decay = Затухание устаревшей коррекции (с)
ai_model-settings-legacy_mode = Режим прежней компенсации дрифта
ai_model-settings-legacy_replace = Заменить прежнюю коррекцию
ai_model-settings-legacy_compose = Скомпоновать с прежней коррекцией
ai_model-mapping-title = Привязка трекеров, ролей тела и слотов модели
ai_model-mapping-empty = Привязки не настроены. Добавьте строку для каждого обслуживаемого моделью трекера.
ai_model-mapping-tracker = ID трекера
ai_model-mapping-role = ID роли тела
ai_model-mapping-slot = Слот модели
ai_model-mapping-add = Добавить привязку
ai_model-mapping-remove = Удалить привязку
ai_model-mapping-apply = Применить привязки
ai_model-trackers-title = Состояние коррекции трекеров по данным сервера
ai_model-trackers-confidence = Confidence
ai_model-trackers-correction = Коррекция
ai_model-trackers-reason = Подробности состояния
ai_model-trackers-applied = Применена
ai_model-trackers-not_applied = Не применена
ai_model-progress-idle = Ожидание
ai_model-progress-catalog = Получение каталога…
ai_model-progress-model = Загрузка модели…
ai_model-progress-metadata = Загрузка метаданных…
ai_model-progress-verifying = Проверка хешей и метаданных…
ai_model-progress-importing = Импорт в управляемое хранилище…
ai_model-progress-activating = Пробный запуск provider и активация…
ai_model-progress-completed = Операция завершена
ai_model-progress-failed = Ошибка операции
ai_model-error-title = Ошибка операции с моделью
ai_model-error-not_connected = Нет соединения с сервером.
ai_model-error-timeout = Сервер не подтвердил операцию с моделью вовремя.
ai_model-error-disconnected = Во время операции с моделью сервер отключился.
