...
websocket-connection_lost-desc = Es sieht so aus, als wäre der NekoVR-Server abgestürzt. Überprüfen Sie die Protokolle und starten Sie das Programm neu.
websocket-timedout = Es konnte keine Verbindung zum Server hergestellt werden.
websocket-timedout-desc = Es sieht so aus, als ob der NekoVR-Server abgestürzt ist oder nicht rechtzeitig geantwortet hat. Überprüfen Sie die Protokolle und starten Sie das Programm neu.
websocket-error-close = NekoVR beenden
websocket-error-logs = Öffne den Logs-Ordner

## Update notification

version_update-title = Neue Version verfügbar: { $version }
version_update-description = Wenn Sie auf "{ version_update-update }" klicken, wird das NekoVR-Installationsprogramm heruntergeladen.
...
tips-turn_on_tracker = Verwenden Sie offizielle NekoVR-Tracker? Vergessen Sie nicht den <b><em>Tracker einzuschalten</em></b>, nachdem Sie ihn an den PC angeschlossen haben!
...
board_type-GLOVE_IMU_SLIMEVR_DEV = NekoVR Dev-IMU-Handschuh
...
tracker-settings-forget-description = Entfernt den Tracker vom NekoVR Server und verhindert, dass er sich wieder verbindet, bis der Server neu gestartet wurde. Die Konfiguration des Trackers geht nicht verloren.
...
settings-general-interface-connected_trackers_warning-description = Diese Option zeigt jedes Mal ein Pop-up-Fenster an, wenn Sie versuchen, NekoVR zu beenden, während ein oder mehrere Tracker verbunden sind. Es erinnert Sie daran, die Tracker auszuschalten, um die Akkulaufzeit zu verlängern.
...
settings-general-interface-use_tray-description = Erlaubt Ihnen, das Fenster zu schließen, ohne den NekoVR-Server zu beenden. Dies erlaubt Ihnen diesen weiterzuverwenden, ohne dass das Fenster stört.
...
settings-general-interface-discord_presence-description = Teilt Ihrem Discord-Client mit, dass Sie NekoVR verwenden, zusammen mit der Anzahl der IMU-Tracker, die Sie benutzen.
...
settings-interface-behavior-error_tracking-description_v2 =
    ...
    <b>Wir erfassen keine personenbezogenen Daten,</b> wie Ihre IP-Adresse oder WLAN-Zugangsdaten. NekoVR respektiert Ihre Privatsphäre!
    
    Um die bestmögliche Benutzererfahrung zu bieten, erfassen wir anonymisierte Fehlerberichte, Leistungsmetriken und Informationen zum Betriebssystem. Dies hilft uns, Fehler und Probleme mit NekoVR zu erkennen. Diese Metriken werden über Sentry.io erfasst.
...
settings-osc-router-network-description =
    ...
    Diese können die selben Ports sein, welche vom NekoVR Server verwendet werden.
...
# This cares about multilines
settings-osc-vmc-description = Einstellungsänderungen spezifisch für das VMC-Protokoll (Virtual Motion Capture Protocol), um die Skelett-Daten von NekoVR zu senden und Skelett-Daten von anderen Applikationen zu empfangen.
...
settings-utils-advanced-open_data-description-v1 = Öffnet den Konfigurationsordner von NekoVR im Explorer, der Konfigurationsdateien enthält
settings-utils-advanced-open_data-label = Ordner öffnen
settings-utils-advanced-open_logs = Logs-Ordner
settings-utils-advanced-open_logs-description = Öffnet den Logs-Ordner von NekoVR im Explorer, der die Protokolle der App enthält.
...
onboarding-home = Willkommen zu NekoVR
...
onboarding-assignment_tutorial = So bereiten Sie einen NekoVR-Tracker vor, bevor Sie diesen anlegen
...
onboarding-assignment_tutorial-second_step-v2 = 2. Befestigen Sie den Riemen an ihrem Tracker, wobei die Klettseite des Riemens in dieselbe Richtung zeigt wie das NekoVR Logo Ihres Trackers:
...
onboarding-automatic_mounting-description = Damit die NekoVR-Tracker korrekt funktionieren, müssen wir ihnen eine Drehung zuweisen, welche der Drehung entspricht wie diese befestigt sind.
...
onboarding-automatic_proportions-description = Damit die NekoVR-Tracker funktionieren, müssen wir Ihre Proportionen kennen. Diese kurze Kalibrierung wird sie für Sie messen.
...
onboarding-automatic_proportions-requirements-descriptionv2 =
    ...
    Ihre Tracker und Ihr Headset ist mit dem NekoVR-Server verbunden und funktionieren ordnunsgemäß (z.B. kein Stottern, kein Trennen der Verbindung, usw.).
    Ihr Headset sendet Positionsdaten an den NekoVR-Server (das bedeutet allgemein, dass SteamVR läuft und über den NekoVR-SteamVR Treiber mit SteamVR verbunden ist).
...
onboarding-user_height-description = Wir brauchen deine Größe, um deine Körperproportionen zu berechnen und deine Bewegungen genau darzustellen. Du kannst dies entweder NekoVR berechnen lassen oder deine Höhe manuell eingeben.
...
trackers_still_on-modal-description =
    ...
    Möchten Sie NekoVR trotzdem beenden?
trackers_still_on-modal-confirm = NekoVR beenden
...
status_system-StatusSteamVRDisconnected =
    { $type ->
        [steamvr_feeder] Derzeit nicht mit der NekoVR-Feeder-Appverbunden.
       *[other] Derzeit nicht über den NekoVR-Treiber mit SteamVR verbunden.
    }
...
firmware_tool-flashbtn_step-board_SLIMEVR = Schalten Sie den Tracker aus, entfernen Sie das Gehäuse (falls vorhanden), verbinden Sie ein USB-Kabel mit diesem Computer und führen Sie dann einen der folgenden Schritte entsprechend Ihrer NekoVR-Board-Revision aus:
...
firmware_update-devices-description = Bitte wählen Sie die Tracker aus, die Sie auf die neueste Version der NekoVR-Firmware aktualisieren möchten
...
unknown_device-modal-description =
    ...
    Möchten Sie diesen mit NekoVR verbinden?
...
vrc_config-page-desc = Diese Seite zeigt den Zustand deiner VRChat-Einstellungen und zeigt, welche Einstellungen mit NekoVR inkompatibel sind. Es wird dringend empfohlen, alle hier angezeigten Warnungen zu beheben, um das beste Nutzererlebnis mit NekoVR zu gewährleisten.
...
tracking_checklist-status-incomplete = Du bist nicht darauf vorbereitet, NekoVR zu benutzen!
tracking_checklist-status-partial =
    { $count ->
        [one] Sie haben 1 Warnung!
       *[other] Sie haben { $count } Warnungen!
    }
tracking_checklist-status-complete = Du bist bereit, NekoVR zu nutzen!
...
tracking_checklist-NETWORK_PROFILE_PUBLIC-desc =
    { $count ->
        [one] Dein Netzwerkprofil ist derzeit auf Öffentlich ({ $adapters }) eingestellt. Dies wird für das ordnungsgemäße Funktionieren von NekoVR nicht empfohlen. <PublicFixLink>Hier erfährst du, wie du das beheben kannst.</PublicFixLink>
       *[other] Einige deiner Netzwerkadapter sind auf Öffentlich eingestellt:¶{ $adapters }¶Das wird nicht empfohlen, damit NekoVR ordnungsgemäß funktioniert.¶<PublicFixLink>Hier erfährst du, wie du das beheben kannst.</PublicFixLink>
    }
