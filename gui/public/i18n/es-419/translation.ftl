...
websocket-connection_lost-desc = Parece que el servidor de NekoVR ha dejado de funcionar. Revise los registros y reinicie el programa.
websocket-timedout = No se ha podido conectar al servidor
websocket-timedout-desc = Parece que el servidor de NekoVR ha dejado de funcionar o se agotó el tiempo de espera de la conexión. Revise los registros y reinicie el programa
websocket-error-close = Salir de NekoVR
websocket-error-logs = Abrir la carpeta de registros

## Update notification

version_update-title = Nueva versión disponible: { $version }
version_update-description = Presionando «{ version_update-update }» descargara un instalador de NekoVR para usar.
...
tips-turn_on_tracker = ¿Estas usando trackers de NekoVR oficiales? ¡Recuerda <b><em>encender tus trackers<em><b> después de conectarlos al PC!
...
board_type-SLIMEVR_DEV = Placa de Desarrollo de NekoVR
...
board_type-GLOVE_IMU_SLIMEVR_DEV = Guante NekoVR Dev IMU
...
tracker-settings-forget-description = Remueve el tracker del servidor de NekoVR y lo previene de conectarse hasta que el servidor se reinicie. La configuración del tracker no se perderá.
...
settings-general-interface-connected_trackers_warning-description = Esta opción hará que aparezca un pop-up cada vez que intentas salir de NekoVR mientras tienes uno o más trackers conectados. Te recuerda de apagar tus trackers cuando ya paraste de usarlos así preservas la duración de la batería.
...
settings-general-interface-use_tray-description = Permite cerrar la ventana sin cerrar el servidor de NekoVR para que puedas continuar usándolo sin que te moleste la interfaz.
...
settings-general-interface-discord_presence-description = Le dice a tu cliente de Discord que estás usando NekoVR junto con la cantidad de sensores IMU que estás usando.
...
settings-interface-behavior-error_tracking-description_v2 =
    ...
    <b>No recopilamos información personal</b> como tu dirección IP o credenciales del Wi-Fi. ¡NekoVR respeta tu privacidad!

    Para proveer la mejor experiencia de usuario, recopilamos reportes de errores anonimizados, métricas de rendimiento, e información del sistema operativo. Esto nos ayuda a detectar errores y problemas con NekoVR. Estas métricas son recopiladas a través de Sentry.io.
...
settings-osc-router-network-description =
    ...
    Estos pueden ser lo mismos puertos usados en el servidor de NekoVR.
...
settings-osc-vmc-description =
    Cambia la configuracion especifica al protocolo VMC (Virtual Motion Capture)
      para enviar datos de los huesos de NekoVR y recibir data de los huesos de otras aplicaciones.
...
settings-utils-advanced-open_data-description-v1 = Abre la carpeta de configuración de NekoVR en el explorador de archivos, que contiene la configuración
settings-utils-advanced-open_data-label = Abrir carpeta
settings-utils-advanced-open_logs = Carpeta de registros
settings-utils-advanced-open_logs-description = Abre la carpeta de registros de NekoVR en el explorador de archivos, que contiene los registros de la aplicación
...
onboarding-setup_warning =
    ...
    y es requerido si es tu primera vez usando NekoVR.
...
onboarding-quiz-slimeset-official-sets = Trackers NekoVR Oficiales
onboarding-quiz-slimeset-thirdparty-sets = Trackers DIY o de terceros
onboarding-quiz-slimeset-answer-regular = NekoVR V1.0 y V1.2
onboarding-quiz-slimeset-answer-butterfly = Mariposa
onboarding-quiz-usage-title = ¿Para que usas tus trackers?
onboarding-quiz-usage-description = Si planeas usar NekoVR para múltiples propósitos, puedes cambiar los ajustes afectados más adelante.
...
onboarding-quiz-mocap_preferences-desc = Especifica cómo planeas usar NekoVR para mocap o VTubing
onboarding-quiz-mocap_preferences-playspace-title = ¿Cuál es tu espacio de juego?
onboarding-quiz-mocap_preferences-playspace-desc = Si estás de pie, NekoVR intentará trackear el movimiento al caminar en vez de anclarte en un lugar.
...
onboarding-wifi_creds-description-v2 =
    La mayoría de trackers (como los trackers oficiales de NekoVR) utilizan Wi-Fi para conectar al servidor.
...
onboarding-home = Bienvenido a NekoVR
...
onboarding-connect_serial-error-modal-no_serial_device_found-desc =
    ...
    Si esto no funciona:
      ...
      - intenta reinstalando el servidor de NekoVR y selecciona «Drivers USB» en la sección de componentes
...
onboarding-automatic_mounting-description = Para que los sensores NekoVR funcionen, necesitamos asignar una posición de montura a tus sensores para que se alinien con la montura física de tu sensor.
...
onboarding-automatic_proportions-description = Para que los sensores de NekoVR funcionen, necesitamos saber el largo de tus huesos. Esta breve calibración los medirá por ti.
...
onboarding-automatic_proportions-requirements-descriptionv2 =
    ...
    Tus sensores y visor están conectados al servidor de NekoVR y están funcionando correctamente (ej: no se congela, no se desconecta, etc).
    Tu visor esta reportando datos posicionales al servidor de NekoVR (esto generalmente significa tener SteamVR abierto y conectado a NekoVR usando el driver de NekoVR para SteamVR).
...
onboarding-user_height-description = Necesitamos tu altura para calcular tus proporciones corporales y representar tus movimientos de manera precisa. Puedes dejar que NekoVR lo calcule, o puedes ingresar tu altura manualmente.
...
trackers_still_on-modal-description =
    ...
    ¿Estás seguro que quieres salir de NekoVR?
trackers_still_on-modal-confirm = Salir de NekoVR
...
status_system-StatusSteamVRDisconnected =
    { $type ->
        [steamvr_feeder] Actualmente no está conectado al NekoVR Feeder
       *[other] Actualmente no está conectado a SteamVR a través del driver de NekoVR.
    }
...
status_system-StatusPublicNetwork = Tu perfil de red está actualmente configurado como Público. Esto no es recomendado para el correcto funcionamiento de NekoVR. <PublicFixLink>Ve como arreglarlo aquí.</PublicFixLink>
...
firmware_tool-flashbtn_step-board_SLIMEVR = Apague el sensor, retire la carcasa (si la hay), conecte un cable USB a esta computadora y, a continuación, realice uno de los siguientes pasos de acuerdo con la revisión de la placa NekoVR:
...
firmware_update-devices-description = Seleccione los sensores que desea actualizar a la última versión del firmware de NekoVR
...
vrc_config-page-desc = Esta página muestra el estado de tus ajustes de VRChat y muestra que ajustes son incompatibles con NekoVR. Es altamente recomendado que arregles cualquier advertencia mostrada aquí para la mejor experiencia de usuario con NekoVR.
...
tracking_checklist-status-incomplete = ¡No estás listo para usar NekoVR!
...
tracking_checklist-status-complete = ¡Estás listo para usar NekoVR!
...
tracking_checklist-NETWORK_PROFILE_PUBLIC-desc =
    { $count ->
        [one]
            ...
            Esto no es recomendado para el correcto funcionamiento de NekoVR.
