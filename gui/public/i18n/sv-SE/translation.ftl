...
websocket-connection_lost-desc = Det verkar som att NekoVR servern kraschade. Kolla loggen och starta om programmet.
websocket-timedout = Kunde ej koppla till servern.
websocket-timedout-desc = Det verkar som att NekoVR servern kraschade eller löpte ur tidsgränsen. Kolla loggen och starta om programmet.
websocket-error-close = Stäng NekoVR
websocket-error-logs = Öppna logg-mappen

## Update notification

version_update-title = Ny version tillgänglig: { $version }
version_update-description = Att trycka på "{ version_update-update }" kommer ladda ner NekoVR installatorn för dig
...
tips-turn_on_tracker = Använder du officiella NekoVR spårare? Glöm inte att <b> <em>sätta på din spårare</em></b> efter du ansluter den till datorn!
...
tracker-settings-forget-description = Tar bort trackern från NekoVR-servern och förhindrar den från att ansluta till den tills servern startas om. Konfigurationen av trackern kommer inte att gå förlorad.
...
settings-general-interface-connected_trackers_warning-description = Detta alternativ kommer att visa ett popup-fönster varje gång du försöker lämna NekoVR medan du har en eller flera anslutna trackers. Det påminner dig om att stänga av dina trackers när du är klar för att spara batteritid.
...
settings-general-interface-use_tray-description = Låter dig stänga fönstret utan att stänga NekoVR-servern så att du kan fortsätta använda den utan att GUI stör dig.
...
settings-general-interface-discord_presence-description = Berättar för din Discord-klient att du använder NekoVR tillsammans med antalet IMU-trackers du använder.
...
# This cares about multilines
settings-osc-router-network-description = Ställ in portarna för att lyssna och skicka data. Dessa kan vara desamma som andra portar som används i NekoVR-servern.
...
settings-utils-advanced-open_data-description-v1 = Öppna NekoVR's config mapp i filutforskaren, som innehåller konfigurationen.
settings-utils-advanced-open_data-label = Öppna mapp
settings-utils-advanced-open_logs = Logg-mapp
settings-utils-advanced-open_logs-description = Öppna NekoVR's config mapp i filutforskaren, som innehåller appens loggar
...
onboarding-setup_warning =
    ...
    den behövs om det är första gången du använder NekoVR.
...
onboarding-home = Välkommen till NekoVR
...
onboarding-connect_serial-error-modal-no_serial_device_found-desc =
    ...
    -Testa installera om NekoVR servern och välj "USB Drivers" i komponentsektionen.
...
onboarding-automatic_mounting-description = För att NekoVR trackers ska fungera, so måste vi tilldela en monterings-riktning för dina trackers för att linjera de med din fysiska tracker-montering.
...
onboarding-automatic_proportions-description = För att NekoVR-trackers ska fungera behöver vi veta längden på dina ben. Denna korta kalibrering kommer att mäta den åt dig.
...
unknown_device-modal-description =
    ...
    Vill du ansluta den till NekoVR?
